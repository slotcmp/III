...
## Статус: Утвержден к изучеинию в Вузах в ConPTY/TTY Windows

---

## 🛑 1. ЧЕТЫРЕ СУВЕРЕННЫХ СМО-ЗАПРЕТА (0% САХАРА)
...
1. **Кудрявцев Е. М.** *Имитационное моделирование на ЭВМ*. — М.: Издательство АСВ, 2002. — 416 с. (Каноническое руководство по дискретно-событийному моделированию сред).
2. **Кудрявцев Е. М.** *Исследование операций в задачах, алгоритмах и программах*. — М.: Радио и связь, 1984. — 184 с. (Фундаментальный базис теории графов, очередей и матричной оптимизации ресурсов ЭВМ).
