...
## Статус: Утвержден к промышленной эксплуатации в ConPTY/TTY Windows
...
![Принципиальная схема ядра slotcmp III]([https://github.com/slotcmp/III/blob/main/images/slotcmp.png)]
```
